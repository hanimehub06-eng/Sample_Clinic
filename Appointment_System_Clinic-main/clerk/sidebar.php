...
// Get today's new appointments count for alerts
$today = date('Y-m-d');
$newToday = dbFetch("
    SELECT COUNT(*) as cnt FROM appointments
    WHERE appointment_date = ? AND status = 'pending'
", [$today]);
$alertCount = $newToday['cnt'] ?? 0;
?>
<aside class="panel-sidebar">
  <div class="sidebar-brand">
    <a href="../index.php">Medi Clinic</a>
    <span class="sidebar-role">Staff Portal</span>
  </div>
  ...
  <nav class="sidebar-nav">
    <a href="index.php" class="nav-item<?= $current === 'index.php' ? ' active' : '' ?>">
      ...
      Dashboard
      <?php if ($alertCount > 0): ?>
      <span class="nav-badge nav-badge-alert"><?= $alertCount ?></span>
      <?php endif; ?>
    </a>
    <a href="schedules.php" class="nav-item<?= $current === 'schedules.php' || $current === 'schedule-edit.php' ? ' active' : '' ?>">
    ...
    <a href="blocked-slots.php" class="nav-item<?= $current === 'blocked-slots.php' ? ' active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18.36 6.64a9 9 0 11-12.73 0"/><line x1="12" y1="2" x2="12" y2="12"/></svg>
      Blocked Slots
    </a>
    ...
    <a href="patients.php" class="nav-item<?= $current === 'patients.php' ? ' active' : '' ?>">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
      Patients
    </a>
