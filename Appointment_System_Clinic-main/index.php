...
<head>
  ...
  <title><?= htmlspecialchars($clinicName) ?> — Where care comes first</title>
...
<section class="hero">
  <div class="hero-content">
    <h1>WELCOME TO <?= strtoupper($clinicName) ?></h1>
    ...
    <div class="info-bar">
      <div class="info-item">
        ...
        <span><?= htmlspecialchars($clinicPhone) ?><br>(Clinic)</span>
      </div>
      <div class="info-item">
        ...
        <span>For emergencies<br>call 911</span>
      </div>
      <div class="info-item">
        ...
        <span><?= htmlspecialchars($clinicAddress) ?></span>
      </div>
    </div>
  </div>
</section>
