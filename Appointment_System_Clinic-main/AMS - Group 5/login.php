...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($accounts[$role])
    ...
    $dest = $role === 'clerk' ? 'clerk/index.php' : 'doctor/index.php';
      ...
      <form method="POST" action="login.php">
        ...
        <div class="login-field">
          ...
          <input type="text" id="username" name="username"
                 placeholder="<?= $role === 'clerk' ? 'clerk' : 'doctor' ?>"
                 value="<?= htmlspecialchars($_POST['username'] ?? '') ?>"
                 autocomplete="username" required>
          <div class="login-hint">Demo: <?= $role === 'clerk' ? '"clerk"' : '"doctor"' ?></div>
        </div>
        ...
        <div class="login-field">
          ...
          <div class="login-hint">Demo: <?= $role === 'clerk' ? '"clerk123"' : '"doctor123"' ?></div>
        </div>
